...
async function handleGetCartSettings(shop: string) {
  ...
  return json({
    ...
    recommendationsBadgeBg: settings.recommendationsBadgeBg || "",
    recommendationsBadgeTextColor: settings.recommendationsBadgeTextColor || "",
    recommendationsBadgeAlign: settings.recommendationsBadgeAlign || "right",
    ...
    cartOffers: settings.cartOffers || [],
    ...
    couponOffersUrl: settings.couponOffersUrl || "",
